...
```{r, results = "asis", echo = FALSE, include = TRUE}
knitr_add_tab_item('top_rows_overlap(res_list, top_n = 918, method = "euler")', 'top_n = 918', opt = 'fig.width = 5, fig.height = 5', prefix = 'top-rows-overlap-by-euler')
...
```{r, results = "asis", echo = FALSE, include = TRUE}
knitr_add_tab_item('top_rows_overlap(res_list, top_n = 918, method = "correspondance")', 'top_n = 918', opt = 'fig.width = 14, fig.height = 8', prefix = 'top-rows-overlap-by-correspondance')
...
```{r, results = "asis", echo = FALSE, include = TRUE}
t2 = Sys.time(); message(paste0(", ", gsub("^ +", "", format(t2 - t1)))); t1 = Sys.time()
message("  - comparing top row methods by heatmap (top_n = 918)", appendLF = FALSE)
knitr_add_tab_item('top_rows_heatmap(res_list, top_n = 918)', 'top_n = 918', opt = 'fig.width = 14, fig.height = 3.5', prefix = 'top-rows-heatmap')
